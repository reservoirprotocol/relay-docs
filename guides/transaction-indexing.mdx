...
description: This guide covers how to properly integrate Relay's transaction indexing APIs into your application flows to ensure all transactions are properly tracked and indexed.
---
...
1. **transactions/index** is for accelerating indexing of transactions with internal deposits
2. **transactions/single** is essential for same-chain operations that aren't automatically monitored
