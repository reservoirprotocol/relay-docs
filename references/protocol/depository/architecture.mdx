...
- <b>deposit methods<b>: these are contract methods that can be called by users to deposit funds (optionally, an id can be attached to every individual deposit)
