...
The current reference implementation of the Hub is centralized service, with short-term plans to move to a decentralized design (eg. Relay Hub as a chain).
