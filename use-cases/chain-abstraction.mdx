...
While not required, resource locks allow cross chain fill time to reduce from seconds to truly instant. We already support Resource Locks from a number of providers like One Balance and will expand to support more over time.